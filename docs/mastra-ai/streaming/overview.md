...
> See [Agent.stream()](https://mastra.ai/reference/streaming/agents/stream) for more information.
...
> See [Agent.network()](https://mastra.ai/reference/agents/network) for more information.
